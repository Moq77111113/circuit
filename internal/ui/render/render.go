...
func Render(nodes []ast.Node, values path.ValuesByPath, focus path.Path) g.Node {
...
func RenderWithOptions(nodes []ast.Node, values path.ValuesByPath, focus path.Path, opts Options) g.Node {
