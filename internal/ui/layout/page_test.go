...
func TestPage_Complete(t *testing.T) {
	...
	html := renderToString(Page(s, nil, "", true, path.Root(), false))
...
func TestPage_CustomTitle(t *testing.T) {
	...
	html := renderToString(Page(s, nil, "My Custom Settings", true, path.Root(), false))
...
func TestPage_WithValues(t *testing.T) {
	...
	html := renderToString(Page(s, values, "", true, path.Root(), false))
...
func TestPage_WithoutBranding(t *testing.T) {
	...
	html := renderToString(Page(s, nil, "", false, path.Root(), false))
